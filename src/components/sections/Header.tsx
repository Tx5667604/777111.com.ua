      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <a href="https://www.google.com/maps/dir/?api=1&destination=place_id:0x40c61955dca38d3f:0x47a6413f2e1ffc99" target="_blank" rel="noopener noreferrer" onClick={trackRouteClick}>
